...
{
    public partial class CtrlLogReports : UserControl
    {
        CtrlReportNav reportNav;
        public CtrlLogReports()
        {
            InitializeComponent();
        ...
        private void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(AppDomain.CurrentDomain.BaseDirectory + @"\RptPatLogs.rpt"); //pangalan nung report mo
