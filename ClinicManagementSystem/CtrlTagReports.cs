...
{
    public partial class CtrlTagReports : UserControl
    {
        public CtrlTagReports()
        {
            InitializeComponent();
        }
        ...
        private void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(AppDomain.CurrentDomain.BaseDirectory + @"\RptTags.rpt"); //pangalan nung report mo
