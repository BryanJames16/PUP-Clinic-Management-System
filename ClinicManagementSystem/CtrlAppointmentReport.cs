...
{
    public partial class CtrlAppointmentReport : UserControl
    {
        public CtrlAppointmentReport()
        {
            InitializeComponent();
        }
        ...
        private void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(AppDomain.CurrentDomain.BaseDirectory + @"\RptAppointments.rpt"); //pangalan nung report mo
